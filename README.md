...
A template for quickly creating basic Android project (Jetpack Compose Version).
...
The template automatically integrates [Flexi UI](https://github.com/BetterAndroid/FlexiUI) and [BetterAndroid](https://github.com/BetterAndroid/BetterAndroid) dependency for you,
which can help make your development easier.

If you need to use traditional development methods, please refer to another template [android-app-template](https://github.com/BetterAndroid/android-app-template).
